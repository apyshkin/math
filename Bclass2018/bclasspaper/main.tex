...
\section{Introduction}
  ...
  \begin{definition}[two point density property]
    ...
    We say that $\fsys$ is \emph{two point dense} if for any $x, y \in \cal{H}$ and $\varepsilon > 0$
      there exists such $T\in \cal{A}$ that $||T(x) - x|| < \varepsilon$ and $||T(y) - y|| < \varepsilon$.
  \end{definition}
    ...
    \subsection{Application of the B-networks criterion to the Larson--Wogen example.}
      ...
      \begin{proof}
        ...
        After that we utilize Theorem~\ref{ray-thm}, which states that there exists such
          ...
          if and only if there exists a ray $r \subseteq \onet $ originating in the vertex $\source$,
