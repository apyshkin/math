...
\section{B-class of vector systems}
  ...
  \subsection{B-class networks characterisation}
    ...
    \begin{proof}
      ...
      Suppose we have already established the flow function $\flowposn{n-1}: \onet \to R^{+}$ for which
      ...
      \begin{proof}
        ...
        We are going to build a ray $R$ lying in the $\cal{P}^*$, thus arriving to a contradiction.
        Let us build the ray $R$ consequtively.
