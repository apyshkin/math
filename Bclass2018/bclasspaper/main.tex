...
\section{Introduction}
  ...
  %\begin{note}
    ...
    the system $\fsys$ is called a strong $M$-basis if for any $x\in\cal{H}$ we have $x \in \overline{span}(\inner{x}{f^*_k}f_k)$, where
...
\section{B-class of vector systems: linear summation problem}
    ...
    Suppose that there is an operator $T$ such that $\inner{Tf_n}{f_n^*} = 0$ for any $n$e
